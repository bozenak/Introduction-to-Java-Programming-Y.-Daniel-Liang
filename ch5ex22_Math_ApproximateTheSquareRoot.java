...
becomes lastGuess and the approximation process continues.
Implement the following method that returns the square root of n:
public static double sqrt(long n)
 */
public class ch5ex22_Math_ApproximateTheSquareRoot {
    ...
    public static double sqrt(long n) {
        long lastGuess = 1;    // The initial guess can be any positive value (e.g., 1).
