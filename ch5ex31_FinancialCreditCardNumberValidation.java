 ...
 */
public class ch5ex31_FinancialCreditCardNumberValidation {
    public static void main(String[] args) {
        ...
        System.out.println(getSize(cardNumber));
        System.out.println(getPrefix(cardNumber, getSize(cardNumber)));
    }
    ...
    /** Return the number of digits in card number */
    public static int getSize(long d) {
        String num = d + "";
        return num.length();
    }

    //Return the first number (k) of digits from number. If the
    //number of digits in number is less than k, return number.
   /* public static int getPrefix(long number){
        int num = (int) (4388576018402626L / 1000000000000000L);
